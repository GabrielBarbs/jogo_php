...
<?php while ($userdata = mysqli_fetch_assoc($result)) : ?>
    ...
    <div class="d-flex align-items-center mb-4">
            <h2 class="me-2">Tela de Edição / Level 5</h2>
        ...
        <form action="salvar/level5.php?id=<?php echo $id?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="1" value="<?php echo $userdata['v_5_1'];?>" class="form-control input-large" name="v_5_1" rows="4" placeholder="Digite a bençao em Fogo" required>
            </div>
            <div class="mb-3">
                <label for="nivel_ref" class="form-label">Bençao em Ar</label>
                <input type="number" step="1" value="<?php echo $userdata['v_5_2'];?>" class="form-control input-large" name="v_5_2" rows="4" placeholder="Digite a bençao em Ar" required>
            </div>
            <div class="mb-3">
                <label for="nivel_ref" class="form-label">Bençao em Agua</label>
                <input type="number" step="1" value="<?php echo $userdata['v_5_3'];?>" class="form-control input-large" name="v_5_3" rows="4" placeholder="Digite a bençao em Agua" required>
            </div>
            <div class="mb-3">
                <label for="nivel_ref" class="form-label">Bençao em Terra</label>
                <input type="number" step="1" value="<?php echo $userdata['v_5_4'];?>" class="form-control input-large" name="v_5_4" rows="4" placeholder="Digite a bençao em Terra" required>
            </div>
