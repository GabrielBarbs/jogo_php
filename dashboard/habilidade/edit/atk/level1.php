...
<?php while ($userdata = mysqli_fetch_assoc($result)) : ?>
    <div class="container mt-5">
        <h2 class="mb-4">Tela de Edição / Level 1</h2>
        <form action="salvar/level1.php?id=<?php echo $id?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="1" value="<?php echo $userdata['v_1_1'];?>" class="form-control input-large" name="v_1_1" rows="4" placeholder="Digite o dano em Fogo" required>
            </div>
            <div class="mb-3">
                <label for="nivel_ref" class="form-label">Dano em Ar</label>
                <input type="number" step="1" value="<?php echo $userdata['v_1_2'];?>" class="form-control input-large" name="v_1_2" rows="4" placeholder="Digite o dano em Ar" required>
            </div>
            <div class="mb-3">
                <label for="nivel_ref" class="form-label">Dano em Agua</label>
                <input type="number" step="1" value="<?php echo $userdata['v_1_3'];?>" class="form-control input-large" name="v_1_3" rows="4" placeholder="Digite o dano em Agua" required>
            </div>
            <div class="mb-3">
                <label for="nivel_ref" class="form-label">Dano em Terra</label>
                <input type="number" step="1" value="<?php echo $userdata['v_1_4'];?>" class="form-control input-large" name="v_1_4" rows="4" placeholder="Digite o dano em Terra" required>
            </div>
