...
<head>
    ...
    <link rel="stylesheet" href="style_dash_hab.css">
...
<button><a href="level/atk/criar_atk_geral.php">Criar Ataque</a></button>
<button><a href="level/def/criar_def_geral.php">Criar Defesa</a></button>
    ...
    <tbody>
        <?php
            while($userdata = mysqli_fetch_assoc($result)){
                ...
                echo "<td>
                <a class='btn btn-sm btn-warning' href='figurinha.php?id=$userdata[ID]'>
