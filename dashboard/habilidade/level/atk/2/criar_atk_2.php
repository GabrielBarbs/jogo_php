...
<body>
    ...
    <form action="criar_atk_2_src.php" method="POST">
        <p>Descriçao:</p>
        ...
        <br>
        <p>Dano (Fogo)</p>
        <input type="text" name="v_2_1" id="v_2_1" placeholder="Digite o dano em fogo (nivel 2)" required>
        <br>
        <p>Dano (Ar)</p>
        <input type="text" name="v_2_2" id="v_2_2" placeholder="Digite o dano em ar (nivel 2)" required>
        <br>
        <p>Dano (Agua)</p>
        <input type="text" name="v_2_3" id="v_2_3" placeholder="Digite o dano em agua (nivel 2)" required>
        <br>
        <p>Dano (Terra)</p>
        <input type="text" name="v_2_4" id="v_2_4" placeholder="Digite o dano em terra (nivel 2)" required>
        <br>
