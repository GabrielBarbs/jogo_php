...
<body>
    ...
    <form action="criar_atk_5_src.php" method="POST">
        ...
        <br>
        <p>Dano (Fogo)</p>
        <input type="text" name="v_5_1" id="v_5_1" placeholder="Digite o dano em fogo (nivel 5)" required>
        <br>
        <p>Dano (Ar)</p>
        <input type="text" name="v_5_2" id="v_5_2" placeholder="Digite o dano em ar (nivel 5)" required>
        <br>
        <p>Dano (Agua)</p>
        <input type="text" name="v_5_3" id="v_5_3" placeholder="Digite o dano em agua (nivel 5)" required>
        <br>
        <p>Dano (Terra)</p>
        <input type="text" name="v_5_4" id="v_5_4" placeholder="Digite o dano em terra (nivel 5)" required>
        <br>
