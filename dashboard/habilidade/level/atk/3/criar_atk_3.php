...
<body class="bg-dark bg-gradient text-white" style="height:862px;">
    <div class="container mt-5">
        <h2 class="mb-4">Nivel 3</h2>
        <form action="criar_atk_3_src.php" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="1" class="form-control" id="v_3_1" name="v_3_1" placeholder="Digite o dano" required>
            </div>
            <div class="mb-3">
                <label for="value" class="form-label">Dano em Ar</label>
                <input type="number" step="1" class="form-control" id="v_3_2" name="v_3_2" placeholder="Digite o dano" required>
            </div>
            <div class="mb-3">
                <label for="value" class="form-label">Dano em Agua</label>
                <input type="number" step="1" class="form-control" id="v_3_3" name="v_3_3" placeholder="Digite o dano" required>
            </div>
            <div class="mb-3">
                <label for="value" class="form-label">Dano em Terra</label>
                <input type="number" step="1" class="form-control" id="v_3_4" name="v_3_4" placeholder="Digite o dano" required>
            </div>
