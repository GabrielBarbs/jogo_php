...
<body>
    ...
    <form action="criar_def_3_src.php" method="POST">
        <p>Descriçao:</p>
        ...
        <br>
        <p>Defesa (Fogo)</p>
        <input type="text" name="v_3_1" id="v_3_1" placeholder="Digite a defesa em fogo (%, nivel 3)" required>
        <br>
        <p>Defesa (Ar)</p>
        <input type="text" name="v_3_2" id="v_3_2" placeholder="Digite a defesa em ar (%, nivel 3)" required>
        <br>
        <p>Defesa (Agua)</p>
        <input type="text" name="v_3_3" id="v_3_3" placeholder="Digite a defesa em agua (%, nivel 3)" required>
        <br>
        <p>Defesa (Terra)</p>
        <input type="text" name="v_3_4" id="v_3_4" placeholder="Digite a defesa em terra (%, nivel 3)" required>
        <br>
