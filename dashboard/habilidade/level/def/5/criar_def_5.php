...
<body class="bg-dark bg-gradient text-white" style="height:862px;">
    ...
    <div class="d-flex align-items-center mb-4">
        ...
        <form action="criar_def_5_src.php" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="number" step="1" class="form-control" id="v_5_1" name="v_5_1" placeholder="Digite a defesa" required>
            </div>
            <div class="mb-3">
                <label for="value" class="form-label">Defesa em Ar</label>
                <input type="number" step="1" class="form-control" id="v_5_2" name="v_5_2" placeholder="Digite a defesa" required>
            </div>
            <div class="mb-3">
                <label for="value" class="form-label">Defesa em Agua</label>
                <input type="number" step="1" class="form-control" id="v_5_3" name="v_5_3" placeholder="Digite a defesa" required>
            </div>
            <div class="mb-3">
                <label for="value" class="form-label">Defesa em Terra</label>
                <input type="number" step="1" class="form-control" id="v_5_4" name="v_5_4" placeholder="Digite a defesa" required>
            </div>
