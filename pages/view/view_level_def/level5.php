...
">
    <div class="row user-details text-white border border-dark rounded align-items-start">
      <?php while ($userdata = mysqli_fetch_assoc($result)) : ?>
        <div class="col">
          <img src="<?php echo "../../../" . $userdata['foto_5']; ?>" alt="<?php echo $userdata['nome']; ?>" class="img-thumbnail" style="
          postion: absolute;
          height: 432px;
          width: 432px;
          ">
        ...
        <div class="col">
          <h1 style="margin-left:200px; postion:absolute;">Nivel 5</h1>
          <h3><?php echo $userdata['desc_5']; ?></h3>
          
        </div>
        <div style="margin-top: 65px;" class="col">
            <h4>Defesa em Fogo:</h4>
            <p><?php echo $userdata['v_5_1']?></p>
            <h4>Defesa em Ar:</h4>
            <p><?php echo $userdata['v_5_2']?></p>
            <h4>Defesa em Agua:</h4>
            <p><?php echo $userdata['v_5_3']?></p>
            <h4>Defesa em Terra:</h4>
            <p><?php echo $userdata['v_5_4']?></p>
          </div>
        <div class="text-white">
          <p>Valor Upgrade:</p>
            <h3><?php echo $userdata['preco_5']; ?></h3>
            <p>Benção:</p>
        ...
        echo"
          ...
          height: 29px;
          margin-left: 312px;
          position: absolute;' href='../view_def.php?id=$id&page=$page'>
          Geral
        ...
        echo"
          ...
          width: 120px;
          margin-left: 803px;
          position: absolute;' href='level4.php?id=$id&page=$page'>
          Nivel 4
          <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-arrow-right-circle' viewBox='0 0 16 16'>
          <path fill-rule='evenodd' d='M1 8a7 7 0 1 0 14 0A7 7 0 0 0 1 8m15 0A8 8 0 1 1 0 8a8 8 0 0 1 16 0M4.5 7.5a.5.5 0 0 0 0 1h5.793l-2.147 2.146a.5.5 0 0 0 .708.708l3-3a.5.5 0 0 0 0-.708l-3-3a.5.5 0 1 0-.708.708L10.293 7.5z'/>
          </svg>
