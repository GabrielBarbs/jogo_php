...
">
    <div class="row user-details text-white border border-dark rounded align-items-start">
      <?php while ($userdata = mysqli_fetch_assoc($result)) : ?>
        <div class="col">
          <img src="<?php echo "../../../" . $userdata['foto_1']; ?>" alt="<?php echo $userdata['nome']; ?>" class="img-thumbnail" style="
          postion: absolute;
          height: 432px;
          width: 432px;
          ">
        ...
        <div class="col">
          <h1 style="margin-left:200px; postion:absolute;">Nivel 1</h1>
          <h3><?php echo $userdata['desc_1']; ?></h3>
          
        </div>
        <div style="margin-top: 65px;" class="col">
            <h4>Defesa em Fogo:</h4>
            <p><?php echo $userdata['v_1_1']?></p>
            <h4>Defesa em Ar:</h4>
            <p><?php echo $userdata['v_1_2']?></p>
            <h4>Defesa em Agua:</h4>
            <p><?php echo $userdata['v_1_3']?></p>
            <h4>Defesa em Terra:</h4>
            <p><?php echo $userdata['v_1_4']?></p>
          </div>
